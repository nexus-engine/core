...
//Windows specific header declaraction for windows callbacks
LRESULT CALLBACK win32_process_message(HWND hwnd, u32 msg, WPARAM w_param, LPARAM l_param);

//Regsiters the platform startup for windows, creating it's application window.
b8 platform_startup(
    ...
    wc.lpszClassName = "nexus_window_class";
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "nexus_window_class", application_name,
